from aat import db
from aat.models import Courses, Assessments, AssessmentQuestions, Type1Questions, Type2Questions
...
course2 = Courses(courseCode = 'CMT220', courseName = 'Databases and Modelling')
